module TD::Types
  ...
  #
  # @attr reply_to [TD::Types::InputMessageReplyTo] Information about the message to be replied;
  #   must be of the type inputMessageReplyToMessage; may be null if none.
