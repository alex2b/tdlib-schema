module TD::Types
  ...
  # @attr accent_color_id [Integer] Identifier of the accent color for message sender name, and backgrounds of chat photo, reply header, and link preview.
  ...
  # @attr profile_background_custom_emoji_id [Integer] Identifier of a custom emoji to be shown on the background of the chat's profile; 0 if none.
  ...
  # @attr chat_lists [Array<TD::Types::ChatList>] Chat lists to which the chat belongs. A chat can have a non-zero position in a chat
  #   list even it doesn't belong to the chat list and have no position in a chat list even it belongs to the chat list.
  # @attr message_sender_id [TD::Types::MessageSender] Identifier of a user or chat that is selected to send messages in the chat;
  #   may be null if the user can't change message sender.
  # @attr block_list [TD::Types::BlockList] Block list to which the chat is added; may be null if none.
  ...
  # @attr view_as_topics [Boolean] True, if the chat is a forum supergroup that must be shown in the "View as topics" mode,
  #   or Saved Messages chat that must be shown in the "View as chats".
  ...
  # @attr message_auto_delete_time [Integer] Current message auto-delete or self-destruct timer setting for the chat, in seconds;
  #   0 if disabled. Self-destruct timer in secret chats starts after the message or its content is viewed.
  #   Auto-delete timer in other chats starts from the send date.
  # @attr emoji_status [TD::Types::EmojiStatus] Emoji status to be shown along with chat title; may be null.
  # @attr background [TD::Types::ChatBackground] Background set for the chat; may be null if none.
  ...
  # @attr  business_bot_manage_bar [TD::Types::BusinessBotManageBar] Information about bar for managing a business bot in the chat;
  #   may be null if none.
