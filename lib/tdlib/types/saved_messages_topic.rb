module TD::Types
  ...
  # @attr is_pinned_ [TD::Types::Bool] True, if the topic is pinned.
  ...
  # @attr last_message [TD::Types::Message] Last message in the topic; may be null if none or unknown.
  # @attr draft_message [TD::Types::DraftMessage] A draft of a message in the topic; may be null if none.
