module TD::Types
  ...
  # @attr has_hidden_members [Boolean] True, if non-administrators can receive only administrators and bots
  #   using getSupergroupMembers or searchChatMembers.
  # @attr can_hide_members [Boolean] True, if non-administrators and non-bots can be hidden in responses to getSupergroupMembers
  ...
  # @attr can_toggle_aggressive_anti_spam [Boolean] True, if aggressive anti-spam checks can be enabled
  #   or disabled in the supergroup.
  ...
  # @attr has_aggressive_anti_spam_enabled [Boolean] True, if aggressive anti-spam checks are enabled in the supergroup.
  #   The value of this field is only available to chat administrators.
  # @attr has_paid_media_allowed [Boolean] True, if paid media can be sent and forwarded to the channel chat; for channels only.
  ...
  # @attr custom_emoji_sticker_set_id [Integer] Identifier of the custom emoji sticker set that can be used in
  #   the supergroup without Telegram Premium subscription; 0 if none.
